...
export function Topbar() {
  ...
  return (
    <header className="flex justify-between items-center w-full px-4 md:px-gutter h-16 sticky top-0 z-40 bg-surface/80 backdrop-blur-md border-b border-outline-variant/20 duration-150 ease-in-out">
      ...
      <div className="hidden md:flex items-center gap-4 flex-1">
        <div className="flex items-center bg-surface-container-low rounded-full px-4 py-2 w-96 border border-outline-variant/30 focus-within:border-secondary focus-within:ring-1 focus-within:ring-secondary transition-all">
      ...
      <div className="md:hidden absolute left-1/2 -translate-x-1/2">
        <span className="font-semibold text-sm text-on-surface tracking-wide">{pageTitle}</span>
      </div>
      ...
      <div className="flex items-center gap-1 relative">
        ...
        <div className="relative">
          <div
            ...
            className="h-8 w-8 ml-1 rounded-full cursor-pointer bg-primary-container flex items-center justify-center text-on-primary-container hover:opacity-80 transition-opacity border-2 border-primary-container/50"
          >
